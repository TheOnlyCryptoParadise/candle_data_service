...
KINESIS_ENABLED=bool(int(environ.get('KINESIS_ENABLED')))

PERIODIC_DOWNLOADER_ENABLED=bool(int(environ.get('PERIODIC_DOWNLOADER_ENABLED')))
...
DB_CONNECTION_ATTEMPTS=environ.get('DB_CONNECTION_ATTEMPTS')
#TESTING = True
#DEBUG = True
