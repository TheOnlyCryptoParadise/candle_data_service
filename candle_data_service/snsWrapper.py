...
class SnsWrapper:
    ...
    def list_topics(self):
        ...
        try:
            ...
            self.logger.info("Got topics.")
        except ClientError:
            self.logger.exception("Couldn't get topics.")
            raise
        else:
            return topics_iter
    ...
    def delete_topic(self, topic):
        ...
        try:
            topic.delete()
            self.logger.info("Deleted topic %s.", topic.arn)
        except ClientError:
            self.flogger.exception("Couldn't delete topic %s.", topic.arn)
            raise
    ...
    def list_subscriptions(self, topic=None):
        ...
        try:
            ...
            self.logger.info("Got subscriptions.")
        except ClientError:
            self.logger.exception("Couldn't get subscriptions.")
            raise
        else:
            return subs_iter

    def add_subscription_filter(self, subscription, attributes):
        """
        ...
        try:
            ...
            self.logger.info("Added filter to subscription %s.", subscription.arn)
        except ClientError:
            self.logger.exception(
    ...
    def delete_subscription(self, subscription):
        ...
        try:
            subscription.delete()
            self.logger.info("Deleted subscription %s.", subscription.arn)
        except ClientError:
            self.logger.exception("Couldn't delete subscription %s.", subscription.arn)
            raise
    ...
    def publish_text_message(self, phone_number, message):
        ...
        try:
            ...
            self.logger.info("Published message to %s.", phone_number)
        except ClientError:
            self.logger.exception("Couldn't publish message to %s.", phone_number)
            raise
        else:
            return message_id
    ...
    def publish_message(self, topic, message, attributes):
        ...
        try:
            ...
            self.logger.exception("Couldn't publish message to topic %s.", topic.arn)
            raise
        else:
            return message_id

    def publish_multi_message(self, 
        ...
        try:
            ...
            message_id = response['MessageId']
            self.logger.info("Published multi-format message to topic %s.", topic.arn)
        except ClientError:
            self.logger.exception("Couldn't publish message to topic %s.", topic.arn)
            raise
        else:
...
def test_dev_main():
    ...
    topic = sns_wrapper.create_topic("")
